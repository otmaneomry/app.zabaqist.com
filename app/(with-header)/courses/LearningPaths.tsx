...
const LearningPaths = () => {
    const courses = [
        { title: 'Algèbre', level: 'BAC', icon: '/brilliant-image/foundational-math.png' },
        { title: 'Analyse', level: 'BAC', icon: '/brilliant-image/foundational-math.png' },
        { title: 'Géométrie', level: 'BAC', icon: '/brilliant-image/foundational-math.png' },
        { title: 'Probabilités', level: 'BAC', icon: '/brilliant-image/foundational-math.png' },
        { title: 'Suites Numériques', level: 'BAC', icon: '/brilliant-image/foundational-math.png' },
        { title: 'Nombres Complexes', level: 'BAC', icon: '/brilliant-image/foundational-math.png' },
    ];
            ...
            <div style={{backgroundColor: 'white', borderRadius: '0.5rem', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)', padding: '1.5rem', marginBottom: '2rem'}}>
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem'}}>
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        <Image src="/brilliant-image/foundational-math.png" alt="Mathématiques BAC" width={48} height={48} style={{marginRight: '1rem'}} />
                        <div>
